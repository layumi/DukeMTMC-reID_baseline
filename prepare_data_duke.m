clear;
p = '/data/uts521/zzd/DukeMTMC/bounding_box_train/';
pp = '/data/uts521/zzd/DukeMTMC/bounding_box_train/*.jpg';
pw = '/data/uts521/zzd/DukeMTMC/bounding_box_train_256/';
mkdir(pw);
...
save('url_data_duke.mat','imdb','-v7.3');
